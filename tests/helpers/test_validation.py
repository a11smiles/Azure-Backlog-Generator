...
def test_validateTags():
    ...
    assert v._validateTags('./somepath/metadata.json', { 'tags' : ['01_Folder']}, _mockConfig()) == True
...
def test_validateRoles():
    ...
    assert v._validateRoles('./somepath/metadata.json', { 'roles' : ['AppDev']}, _mockConfig()) == True
...
def test_validateConfig():
    ...
    assert v.validateConfig('./somepath/config.json', { 'tags': ['0f_Folder'], 'roles' : ['AppDev'] }) == True